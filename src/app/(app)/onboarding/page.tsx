  ...
  return (
    <div className="mx-auto max-w-lg">
      ...
      <div className="glass rounded-3xl p-6">
        ...
        {step === 1 ? (<div className="space-y-4"><h2 className="text-xl font-semibold">Income / pocket money</h2><p className="text-sm text-muted-foreground">Salary, freelance earnings, or the pocket money and allowance you get each month if you are studying. Rough is fine.</p><Field label="Monthly income / pocket money" htmlFor="ob-income" hint="What actually reaches you each month, after tax if you pay any."><Input id="ob-income" type="number" inputMode="decimal" min={0} value={income} onChange={(e) => setIncome(e.target.value)} autoFocus /></Field><Field label="Day of month it arrives" htmlFor="ob-day" hint="Salary date or the day you usually get pocket money. This starts your budget period."><Input id="ob-day" type="number" min={1} max={28} value={incomeDay} onChange={(e) => setIncomeDay(e.target.value)} /></Field></div>) : null}
